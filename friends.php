...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/vertical-ticker-sty">
...
<!-- pop up -->
<!-- add friend -->
        <div id="modal1" style="position:static; width:500px; margin-right:auto; margin-left:auto" >
            <div class="modal1-content" style="position:absolute;">
    ...
    <!-- <div id="modal2">
     ...
     -->
    <!-- /dl-menuwrapper -->
        <li class="gn-trigger" style="top:inherit">
...
<!--i think there should be a </div> here -->
<!-- Footer -->
